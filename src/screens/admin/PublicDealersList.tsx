...
import PublicDealerTable from '@/components/admin/ui/table/PublicDealerTable';
...
const PublicDealersList: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['get-public-dealers', currentPage, limit, debouncedSearchTerm],
    enabled: true,
  });
...
export default PublicDealersList;
